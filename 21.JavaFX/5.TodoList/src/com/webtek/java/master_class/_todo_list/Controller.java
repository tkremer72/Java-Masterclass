...
public class Controller {
                ...
                ListCell<TodoItem> cell = new ListCell<>() {
                    ...
                    protected void updateItem(TodoItem item, boolean empty) {
                        ...
                        if (empty) {
                            ...
                            if (item.getDeadline().isBefore(LocalDate.now().plusDays(1))) {//before today or today
                                setTextFill(Color.RED);
                            } else if (item.getDeadline().equals(LocalDate.now().plusDays(1))) {//after today
    ...
    public void showNewItemDialog() {
        ...
        dialog.setHeaderText("Enter Your New Todo Information Below.");
